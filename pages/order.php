                                            ...
                                            <div style="margin-left:1px; margin-top:2px; margin-right:10px "><br>
                                                ...
                                                <div style="margin-right:95px " class="item">Тип путевки</div>
                                                    ...
                                                    <select name='voucher' id='voucher'>
                                                        <option value='cruise'>".$VOUCHER_TYPE['cruise']['name']."</option>
                                                        <option value='safari'>".$VOUCHER_TYPE['safari']['name']."</option>
                                                        <option value='gastrotur'>".$VOUCHER_TYPE['gastrotur']['name']."</option>
                                                    </select>
                                                </div>";
                                                    ?>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">                                   
                                                <tr>
                                                    <td valign="top" height="232" width="248">
                                                        ...
                                                        <?php
                                                            foreach ($FOOD_TYPE as $key => $value){
                                                                echo "<div class='item'>
                                                                <input type='radio' name='food_type' id=$key value=$key />
                                                    ...
                                                    <td valign="top" height="215" width="243">
                                                        ...
                                                        <div class="item">Ваши данные</div>
                                                        <div class="order-table-your-data">
